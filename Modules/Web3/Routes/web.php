...
Route::prefix('webhook')->group(function () {
    Route::get('/alchemy/{code}', [AlchemyController::class, 'webhook'])->name('webhook.alchemy.get');
    Route::post('/alchemy/{code}', [AlchemyController::class, 'webhook'])->name('webhook.alchemy.post');
});
