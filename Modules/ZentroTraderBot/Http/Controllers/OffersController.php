...
class OffersController extends Controller
{
    ...
    private function cancelWizardResponse($bot): array
    {
        ...
        return [
            "text" =>
                "❌ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.cancelled_title")) . "*\n" .
                "_" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.cancelled")) . "_\n\n" .
    ...
    private function stepAmount($bot, array $state): array
    {
            ...
            if (!is_numeric($text) || $text <= 0) {
                return [
                    "text" =>
                        ...
                        "◾️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step", ['n' => TextService::getNumberAsEmoji(1), 'total' => TextService::getNumberAsEmoji(5)])) . "_\n" .
                        "▫️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.subtitle")) . "*\n" .
                        "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.invalid_amount", ['value' => $text])) . "\n" .
                        "▫️ " . ($isSell
                            ? TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.ask_sell_available", ['balance' => $balance]))
                            : TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.ask_buy"))) . "\n" .
                        "▫️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.number_hint")) . " `" . ($balance ?: 100) . "`",
                    "chat" => ["id" => $userId],
                    "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.cancel")), "callback_data" => "/wizardcancel"]]]]),
                    "editprevious" => 1,
                ];
            }
            ...
            if ($isSell && (float) $text > $balanceRaw) {
                return [
                    "text" =>
                        ...
                        "◾️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step", ['n' => TextService::getNumberAsEmoji(1), 'total' => TextService::getNumberAsEmoji(5)])) . "_\n" .
                        "▫️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.subtitle")) . "*\n" .
                        "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.selling_too_much", ['amount' => $text])) . "\n" .
                        "▫️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.ask_sell_available", ['balance' => $balance])) . "\n" .
                        "▫️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.number_hint")) . " `{$balance}`",
                    "chat" => ["id" => $userId],
                    "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.cancel")), "callback_data" => "/wizardcancel"]]]]),
                    "editprevious" => 1,
                ];
        ...
        $amountPrompt = $isSell
            ? "▫️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.ask_sell_available", ['balance' => $balance])) . "\n" .
            "▫️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.number_hint")) . " `{$balance}`"
            : "▫️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step1.ask_buy")) . "_";
    ...
    private function stepCurrency($bot, array $state): array
    {
        ...
        $currencyPrompt = $isSell
            ? TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step2.ask_sell"))
            : TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step2.ask_buy"));

        return [
            "text" =>
                "✨ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.title")) . "*\n" .
                "▫️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step", ['n' => TextService::getNumberAsEmoji(2), 'total' => TextService::getNumberAsEmoji(5)])) . "_\n" .
                "◾️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step2.subtitle")) . "*\n" .
                "▫️ \n" .
                "▫️ _{$currencyPrompt}_\n" .
                "▫️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step2.select_available")) . " 👇",
            "chat" => ["id" => $userId],
        ...
        if ($text !== null) {
            ...
            if (!is_numeric($text) || $text <= 0) {
                return [
                    "text" =>
                        "✨ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.title")) . "*\n" .
                        "▫️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step", ['n' => TextService::getNumberAsEmoji(3), 'total' => TextService::getNumberAsEmoji(5)])) . "_\n" .
                        "▫️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step3.subtitle", ['coin' => $coin])) . "*\n" .
                        "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step3.invalid_price", ['value' => $text])) . "\n" .
                        "▫️ " . ($isSell
                            ? TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step3.ask_sell", ['coin' => $coin]))
                            : TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step3.ask_buy", ['coin' => $coin]))) . "\n" .
                        "▫️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step3.example")) . " `" . number_format($val, 2) . "`",
                    "chat" => ["id" => $userId],
    ...
    private function stepMethod($bot, array $state): array
    {
        ...
        $methodPrompt = $isSell
            ? TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step4.ask_sell", ['currency' => $state['data']['currency']]))
            : TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step4.ask_buy", ['currency' => $state['data']['currency']]));

        return [
            "text" =>
                "✨ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.title")) . "*\n" .
                "▫️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step", ['n' => TextService::getNumberAsEmoji(4), 'total' => TextService::getNumberAsEmoji(5)])) . "_\n" .
                "▫️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step4.subtitle")) . "*\n" .
                "▫️ \n" .
                "▫️ _{$methodPrompt}_\n" .
                "◾️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.step4.select_available")) . " 👇",
            "chat" => ["id" => $userId],
            "reply_markup" => json_encode(["inline_keyboard" => $buttons]),
            "editprevious" => 1,
        ];
    ...
    private function stepConfirm($bot, array $state): array
    {
        ...
        $confirmLabel = $isSell ? "💵 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.confirm.selling")) : "🟢 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.confirm.buying"));
        $resultLabel = $isSell ? "💱 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.confirm.receiving")) : "💱 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.confirm.paying"));

        return [
            "text" =>
                "✨ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.wizard.confirm.title")) . "*\n" .
                "{$confirmLabel}: *" . TextService::mdv2($state['data']['amount']) . " USD* a *" . TextService::mdv2($state['data']['price']) . " {$state['data']['currency']}/USD*\n" .
                "{$resultLabel}: *" . TextService::mdv2($total) . " {$state['data']['currency']}*\n" .
                "🏦 " . TextService::mdv2($state['data']['method_name']) . ": `{$state['data']['details']}`\n" .
                "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.whatsnext")),
            "chat" => ["id" => $userId],
            "reply_markup" => json_encode([
                "inline_keyboard" => [
                    [["text" => "✅ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.publish")), "callback_data" => "/offerconfirm"]],
                    [
                        ["text" => "⬅️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.back")), "callback_data" => "/wizardprevious"],
                        ["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.cancel")), "callback_data" => "/wizardcancel"],
                    ],
    ...
    private function publishOffer($bot, $state, $stars = "")
    {
        ...
        if ($response) {
            ...
            $text = "✅ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.title")) . "*\n";
            $text .= "📢 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.published")) . "\n\n";
            $text .= "⚠️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.security_notes")) . "*\n";

            if ($isSell) {
                $text .= "🔒 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.sell_lock")) . "*\n";
                $text .= "🚫 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.sell_rule")) . "*\n";
            } else {
                $text .= "🔒 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.buy_custody")) . "*\n";
                $text .= "🚫 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.buy_rule")) . "*\n";
            }

            $text .= "⚖️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.arbitrage")) . "*\n\n";
            $text .= "👍 " . ($isSell
                ? TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.goodluck_sell"))
                : TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.goodluck_buy"))) .
                " _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.notify")) . "_";
            ...
            return [
                ...
                "reply_markup" => json_encode([
                    "inline_keyboard" => [
                        [
                            ["text" => "👀 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.view_my_offer")), "url" => "https://t.me/KashioChannel/{$messageId}"]
                        ],
                        [
                            ["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]
                        ]
        ...
        return [
            "text" => "❌ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.error")) . "*\n_" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer_publish.error_retry")) . "_",
            "chat" => ["id" => $bot->actor->user_id]
        ];
    }
    ...
    public function showOffer($bot, $code, $menu = false)
    {
        ...
        if ($offer && $offer->id > 0) {
            ...
            $text = "🤔 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.show_offer.not_found_title")) . "*\n";
            $text .= "_" . TextService::mdv2(Lang::get("zentrotraderbot::bot.show_offer.not_found")) . "_\n\n";
            $text .= "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.whatsnext"));
        }
    ...
    public function applyForOffer($bot, $code)
    {
        ...
        if (!Cache::add($lockKey, $bot->actor->user_id, now()->addMinutes(5))) {
            ...
            if ($whoIsApplying != $bot->actor->user_id) {
                $this->updateStatus($bot, "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.apply_offer.being_processed")));
                return true;
            }
        }
        ...
        if (!$offer || strtoupper($offer->status) !== 'OPEN') { // Validación extra de estado
            $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.apply_offer.not_available", ['code' => $code])));
        ...
        try {
            ...
            if (!$txHash) {
                $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.apply_offer.no_hash")));
                Cache::forget($lockKey);
                UpdateOfferInChannel::dispatch($bot->tenant->key, $code);
                return false;
            }
    ...
    public function recoverOffer($bot, $code)
    {
        ...
        $this->updateStatus($bot, "⏳ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.checking")) . "*");
        ...
        if (!$blockchainTrade) {
            $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.not_found_blockchain")));
            return false;
        }
        ...
        if ($now < $timeoutAt) {
            ...
            $this->updateStatus(
                $bot,
                "🚫 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.wait", ['minutes' => $minutes])) . "\n\n"
                . "🔔 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.wait_scheduled"))
            );
        ...
        $this->updateStatus($bot, "⚖️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.requesting")) . "*");
        ...
        try {
            ...
            if (!$txHash) {
                $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.rejected")));
                return false;
            }

            $this->logOfferAction($offer, 'seller', 'offer_recovered', $bot->actor->user_id, $bot->message['text'] ?? '', ['code' => $offer->code, 'tx_hash' => $txHash]);
            $this->updateStatus($bot, "✅ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.success", ['amount' => number_format($offer->amount, 2)])) . "*");

            return $txHash;

        } catch (\Exception $e) {
            $this->updateStatus($bot, "❌ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.recover_offer.error")) . "* " . TextService::mdv2($e->getMessage()));
            return false;
        }
    }
    ...
    public function rateOfferPerformance($bot, $code, $stars)
    {
        ...
        if ($offer) {
            ...
            $text = "✅ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.success_title")) . "*\n";
            $text .= "🙏 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.thanks")) . "\n\n";
            $text .= "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.whatsnext"));

        } else {
            $text = "🤔 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.not_found_title")) . "*\n";
            $text .= "_" . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.not_found")) . "_\n\n";
            $text .= "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.whatsnext"));
        }
        array_push($menu, [
            ["text" => "⬅️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.backtop2pmenu")), "callback_data" => "/p2pmenu"],
    ...
    public function startRatingWizard($bot, $code, $stars)
    {
        ...
        if (!$offer) {
            $payload = [
                "message" => [
                    "text" => "🤔 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.not_found_title")) . "*\n"
                        . "_" . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.not_found")) . "_\n\n"
                        . "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.whatsnext")),
                    "chat" => ["id" => $bot->actor->user_id],
                    "message_id" => $bot->message["message_id"],
                    "parse_mode" => "MarkdownV2",
                    "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]]]]),
                ],
            ];
            try {
                TelegramController::editMessageText($payload, $bot->tenant->token);
    ...
    private function runRatingWizard($bot, array $initialData = [])
    {
        ...
        return (new WizardController())->run($bot, [
            ...
            'onCancel' => fn($b) => [
                "text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.cancelled")),
    ...
    private function stepRatingComment($bot, array $state): array
    {
        ...
        return [
            "text" => "⭐ " . $stars . "/5\n\n💬 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.comment_prompt")) . "\n\n_" . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.comment_prompt_italic")) . "_",
            "chat" => ["id" => $userId],
            "reply_markup" => json_encode([
                "inline_keyboard" => [
                    [
                        ["text" => "🙅 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.comment_skip")), "callback_data" => "ratingskip {$code}"],
                    ]
                ]
            ]),
        ];
    ...
    private function completeRating($bot, array $state): array
    {
        ...
        $successText = "✅ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.success_title")) . "*\n"
            . "🙏 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.rate_offer.thanks")) . "\n\n"
            . "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.whatsnext"));
        $menu = json_encode(["inline_keyboard" => [[["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]]]]);

        if ($isCallback) {
            $payload = ["message" => ["text" => $successText, "chat" => ["id" => $userId], "message_id" => $bot->message["message_id"], "parse_mode" => "MarkdownV2", "reply_markup" => $menu]];
            try {
                TelegramController::editMessageText($payload, $bot->tenant->token);
            } catch (\Throwable $th) {
            }
    ...
    public function getActiveOffers($suscriptor, $page = 1)
    {
        ...
        if ($offers->isEmpty()) {
            return [
                "text" => "📭 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.active_offers.empty")) . "*\n" .
                    TextService::mdv2(Lang::get("zentrotraderbot::bot.active_offers.empty_cta")),
                "reply_markup" => json_encode([
                    "inline_keyboard" => [
                        [
                            ["text" => "⬅️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.backtop2pmenu")), "callback_data" => "/p2pmenu"]
        ...
        $text = "📋 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.active_offers.title")) . "*\n";
        $text .= "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.chooseoneoption"));
        ...
        $navigation = [];
        if ($page > 1)
            $navigation[] = ["text" => "◀️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.previous")), "callback_data" => "/activeoffers " . ($page - 1)];
        if ($total > ($page * $perPage))
            $navigation[] = ["text" => TextService::mdv2(Lang::get("zentrotraderbot::bot.options.next")) . " ▶️", "callback_data" => "/activeoffers " . ($page + 1)];
        ...
        // Botón para volver
        $buttons[] = [["text" => "⬅️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.backtop2pmenu")), "callback_data" => "/p2pmenu"]];
        $buttons[] = [["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]];
    ...
    public function comprobantOffer($bot, $code)
    {
        $offer = Offers::findByCode($code);
        if (!$offer) {
            $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.not_found")));
            return false;
        }

        if (!in_array(strtoupper($offer->status), ['LOCKED', 'SIGNED'])) {
            $this->updateStatus($bot, "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.wrong_state")));
            return false;
        }

        $buyer = Suscriptions::on('tenant')->where('user_id', $bot->actor->user_id)->first();
        if (!$buyer) {
            $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.account_not_found")));
            return false;
        }
        ...
        $this->updateStatus($bot, "⌛️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.sending_proof")));
        ...
        try {
            ...
            if (!$txHash) {
                $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.no_confirm_payment")));
                return false;
            }
    ...
    public function signOffer($bot, $code)
    {
        ...
        $this->updateStatus($bot, "⌛️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.confirming_receipt")));
        ...
        try {
            ...
            if (!$txHash) {
                $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.no_sign")));
                return false;
            }
    ...
    public function cancelOnChain($bot, $code)
    {
        $offer = Offers::findByCode($code);
        if (!$offer) {
            $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.cancel_onchain.not_found")));
            return false;
        }

        if (strtoupper($offer->status) !== 'LOCKED') {
            $this->updateStatus($bot, "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.cancel_onchain.wrong_state")));
            return false;
        }

        $buyer = Suscriptions::on('tenant')->where('user_id', $bot->actor->user_id)->first();
        if (!$buyer || strtolower($buyer->data['wallet']['address']) !== strtolower($offer->buyer_address)) {
            $this->updateStatus($bot, "🚫 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.cancel_onchain.not_buyer")));
            return false;
        }
        ...
        $this->updateStatus($bot, "⌛️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.cancel_onchain.processing")));
        ...
        try {
            ...
            if (!$txHash) {
                $this->updateStatus($bot, "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.cancel_onchain.no_cancel")));
                return false;
            }
    ...
    private function runProofWizard($bot, array $initialData = [])
    {
        ...
        return (new WizardController())->run($bot, [
            ...
            'onCancel' => fn($b) => [
                "text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.cancelled")),
                "chat" => ["id" => $b->actor->user_id],
                "editprevious" => (isset($b->callback_query) || ($b->is_callback ?? false)) ? 1 : 0,
                "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]]]]),
            ],
    ...
    private function stepProofCollecting($bot, array $state): array
    {
        ...
        $userId = $bot->actor->user_id;
        $code = $state['data']['offer_code'];
        $cancelBtn = [["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.cancel")), "callback_data" => "/wizardcancel"]];
        ...
        if ($isValidImage) {
            ...
            $msgText = "✅ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.image_received", ['count' => count($currentImages)]))
                . "\n🤔 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.ask_more"));
            $buttons = json_encode([
                "inline_keyboard" => [
                    [
                        ["text" => TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.yes_more")), "callback_data" => "proofmore {$code}"],
                        ["text" => TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.no_done")), "callback_data" => "proofdone {$code}"],
                    ]
                ],
            ]);
            ...
            if ($mediaGroupId) {
                ...
                if ($isFirst) {
                    ...
                    $resp = TelegramController::sendMessage([
                        "message" => ["text" => $msgText, "chat" => ["id" => $userId], "parse_mode" => "MarkdownV2", "reply_markup" => $buttons],
                    ], $bot->tenant->token);
                    ...
                    if ($messageId) {
                        TelegramController::editMessageText([
                            "message" => ["chat" => ["id" => $userId], "message_id" => $messageId, "text" => $msgText, "parse_mode" => "MarkdownV2", "reply_markup" => $buttons],
                        ], $bot->tenant->token);
                    }
                }
        ...
        if ($isOtherMedia) {
            return [
                "text" => "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.invalid_content")) . "\n📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.instructions")),
                "chat" => ["id" => $userId],
        ...
        if (str_contains(strtolower($text), 'proofdone')) {
            if (empty($state['data']['images'])) {
                return [
                    "text" => "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.no_images")) . "\n\n📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.instructions")),
                    "chat" => ["id" => $userId],
                    "editprevious" => 1,
                    "reply_markup" => json_encode(["inline_keyboard" => [$cancelBtn]]),
                ];
        ...
        return [
            "text" => "📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_wizard.instructions")),
            "chat" => ["id" => $userId],
            "reply_markup" => json_encode(["inline_keyboard" => [$cancelBtn]]),
        ];
    }
    ...
    public function buildEvidenceWizardPromptText(Offers $offer, string $context = 'dispute'): string
    {
        $contextLine = $context === 'more'
            ? "🔔 _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.more_requested_body")) . "_"
            : "⚖️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.arbiter_dispute_context")) . "_";

        return "🧾 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.title")) . "*\n"
            . "🆔 `{$offer->code}`\n\n"
            . "{$contextLine}\n\n"
            . "📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.instructions"));
    }
    ...
    private function runEvidenceWizard($bot, array $initialData = [])
    {
        ...
        return (new WizardController())->run($bot, [
            ...
            'onCancel' => fn($b) => [
                "text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.cancelled")),
                "chat" => ["id" => $b->actor->user_id],
                "editprevious" => (isset($b->callback_query) || ($b->is_callback ?? false)) ? 1 : 0,
                "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]]]]),
            ],
    ...
    private function stepEvidenceCollecting($bot, array $state): array
    {
        ...
        if ($isValidImage) {
            ...
            $msgText = "✅ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.image_received", ['count' => count($currentImages)]))
                . "\n🤔 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.ask_more"));
            $buttons = json_encode([
                "inline_keyboard" => [
                    [
                        ["text" => TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.yes_more")), "callback_data" => "evimore {$code}"],
                        ["text" => TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.no_done")), "callback_data" => "evidone {$code}"],
                    ]
                ],
            ]);
        ...
        if ($isOtherMedia) {
            return [
                "text" => "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.invalid_content")) . "\n📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.instructions")),
                "chat" => ["id" => $userId],
                "reply_markup" => json_encode(["inline_keyboard" => [$cancelBtn]]),
            ];
        }
        ...
        if (str_contains(strtolower($text), 'evidone')) {
            if (empty($state['data']['images'])) {
                return [
                    "text" => "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.no_images")) . "\n\n📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.instructions")),
                    "chat" => ["id" => $userId],
                    "editprevious" => 1,
                    "reply_markup" => json_encode(["inline_keyboard" => [$cancelBtn]]),
                ];
        ...
        $offer = Offers::findByCode($code);
        return [
            "text" => "🧾 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.title")) . "*\n"
                . ($offer ? "🆔 `{$offer->code}`\n\n" : "")
                . "📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.instructions")),
            "chat" => ["id" => $userId],
            "reply_markup" => json_encode(["inline_keyboard" => [$cancelBtn]]),
    ...
    private function completeEvidence($bot, array $state): array
    {
        ...
        if ($offer) {
            ...
            foreach ($admins as $admin) {
                TelegramController::sendMessage([
                    "message" => [
                        "text" => "⚖️ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.arbiter_notification_title")) . "*\n🆔 `{$offer->code}`\n\n" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.arbiter_notification_body")),
                ...
                foreach ($evidenceByUser as $senderId => $fileIds) {
                    TelegramController::sendMessage(["message" => ["text" => "👤 ID: `{$senderId}`", "chat" => ["id" => $admin->user_id], "parse_mode" => "MarkdownV2"]], $botTenant->token);
                    if (count($fileIds) === 1) {
            ...
            if ($threadId && $supportId) {
                ...
                if (!empty($newFileIds)) {
                    ...
                    $label = match ($role) {
                        'buyer' => "*" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer.disputed.by_buyer")) . "* 🟢",
                        'seller' => "*" . TextService::mdv2(Lang::get("zentrotraderbot::bot.offer.disputed.by_seller")) . "* 🔴",
                        default => "👤 ID: `{$userId}`",
                    };
        ...
        return [
            "text" => "✅ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.arbiter_notified")),
            "chat" => ["id" => $userId],
            "editprevious" => 1,
            "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]]]]),
        ];
    ...
    public function requestMoreEvidence($bot, $code)
    {
        ...
        if (!$offer || strtoupper($offer->status) !== 'DISPUTED') {
            return [
                "text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.not_found")),
                "chat" => ["id" => $bot->actor->user_id],
            ];
        }
        ...
        $cancelMenu = [[["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.cancel")), "callback_data" => "/wizardcancel"]]];
        ...
        if ($threadId && $supportId) {
            TelegramController::sendMessage([
                "message" => [
                    "text" => "🔔 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.thread_more_requested")) . "*",
                    "chat" => ["id" => $supportId],
                    "parse_mode" => "MarkdownV2",
        ...
        return [
            "text" => "✅ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.more_requested_sent")),
            "chat" => ["id" => $bot->actor->user_id],
            "editprevious" => 1,
            "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]]]]),
        ];
    ...
    public function notReceivedPayment($bot, $code)
    {
        ...
        if ($buyerSub && $buyerSub->user_id) {
            ...
            $text = "🧾 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.title")) . "*\n"
                . "🆔 `{$offer->code}`\n\n"
                . "⚠️ _" . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_resubmit.wizard_context")) . "_\n\n"
                . "📸 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.instructions"));
            ...
            TelegramController::sendMessage([
                "message" => [
                    ...
                    "reply_markup" => json_encode([
                        "inline_keyboard" => [
                            [["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.cancel")), "callback_data" => "/wizardcancel"]],
                            [["text" => "⚖️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.open_dispute")), "callback_data" => "/disputebybuyer {$offer->code}"]],
                        ]
                    ]),
                ],
            ], $botTenant->token);
        ...
        return [
            "text" => "✅ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_resubmit.seller_notified")),
            "reply_markup" => json_encode([
                "inline_keyboard" => [
                    [["text" => "👍 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.confirm_received")), "callback_data" => "/signoffer {$offer->code}"]],
                    [["text" => "⬅️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.backtop2pmenu")), "callback_data" => "/p2pmenu"]],
                    [["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]],
                ]
            ]),
    ...
    public function startProofResubmitWizard($bot, $code)
    {
        $offer = Offers::findByCode($code);
        if (!$offer) {
            return ["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.not_found"))];
        }
        $bot->message['text'] = null;
    ...
    private function runProofResubmitWizard($bot, array $initialData = [])
    {
        ...
        return (new WizardController())->run($bot, [
            ...
            'onCancel' => fn($b) => [
                "text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_resubmit.cancelled")),
                "chat" => ["id" => $b->actor->user_id],
                "editprevious" => (isset($b->callback_query) || ($b->is_callback ?? false)) ? 1 : 0,
                "reply_markup" => json_encode(["inline_keyboard" => [[["text" => "↖️ " . TextService::mdv2(Lang::get("telegrambot::bot.options.backtomainmenu")), "callback_data" => "menu"]]]]),
            ],
    ...
    private function stepProofResubmitCollecting($bot, array $state): array
    {
        ...
        $code = $state['data']['offer_code'];
        $cancelBtn = [["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.cancel")), "callback_data" => "/wizardcancel"]];
        $disputeBtn = [["text" => "⚖️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.open_dispute")), "callback_data" => "/disputebybuyer {$code}"]];
        ...
        if ($isValidImage) {
            ...
            $buttons = json_encode([
                "inline_keyboard" => [
                    [
                        ["text" => TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.yes_more")), "callback_data" => "proofresmore {$code}"],
                        ["text" => TextService::mdv2(Lang::get("zentrotraderbot::bot.evidence_wizard.no_done")), "callback_data" => "proofresdone {$code}"],
                    ]
                ],
            ]);
    ...
    private function completeProofResubmit($bot, array $state): array
    {
        ...
        $offer = Offers::findByCode($code);
        if (!$offer) {
            return ["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.sign_offer.not_found")), "chat" => ["id" => $userId]];
        }
        ...
        if ($sellerSub && $sellerSub->user_id) {
            ...
            $confirmMenu = [
                [
                    ["text" => "👍 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.confirm_received")), "callback_data" => "/signoffer {$offer->code}"],
                    ["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.not_received")), "callback_data" => "/notreceived {$offer->code}"],
                ],
                [["text" => "⚖️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.options.open_dispute")), "callback_data" => "/disputebyseller {$offer->code}"]],
            ];
            TelegramController::sendMessage([
                "message" => [
                    "text" => "👆 *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_resubmit.new_evidence_title")) . "*\n"
                        . "🆔 `{$offer->code}`\n\n"
                        . "🏦 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_resubmit.new_evidence_body")),
        ...
        return [
            "text" => "✅ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_resubmit.buyer_submitted")),
            "chat" => ["id" => $userId],
            "reply_markup" => json_encode([
                "inline_keyboard" => [
                    [
    ...
    public function openDispute($bot, $code)
    {
        ...
        $this->updateStatus($bot, "⌛️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.proof_resubmit.opening_dispute")));
    ...
    public function chatRelay($bot)
    {
        ...
        if (!$counterpartSub || !$counterpartSub->user_id) {
            return ["text" => "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.chat.counterpart_unavailable"))];
        }
    ...
    public function exitChat($bot)
    {
        ...
        return [
            "text" => "🚪 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.chat.exited")),
            "chat" => ["id" => $bot->actor->user_id],
        ];
    }
    ...
    public function requestNewEvidenceFromUser($bot, $code, $userId)
    {
        $offer = Offers::findByCode($code);
        if (!$offer || strtoupper($offer->status) !== 'DISPUTED') {
            return ['text' => '❌ ' . TextService::mdv2(Lang::get('zentrotraderbot::bot.sign_offer.not_found')), 'chat' => ['id' => $bot->actor->user_id]];
        }
        ...
        if ($threadId && $supportId) {
            TelegramController::sendMessage([
                'message' => [
                    'text' =>
                        "✅ " . TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.insufficient_thread_note')) . "\n" .
                        "🆔 `{$userId}`",
                    'chat' => ['id' => $supportId],
                    'parse_mode' => 'MarkdownV2',
                    'message_thread_id' => (int) $threadId,
        ...
        return [
            'text' => '✅ ' . TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.insufficient_sent')),
            'chat' => ['id' => $bot->actor->user_id],
            'editprevious' => 1,
            'reply_markup' => json_encode(['inline_keyboard' => [[['text' => '↖️ ' . TextService::mdv2(Lang::get('telegrambot::bot.options.backtomainmenu')), 'callback_data' => 'menu']]]]),
        ];
    ...
    public function requestEvidenceFromCounterpart($bot, $code, $userId)
    {
        ...
        if (!$counterpartId) {
            return ['text' => '❌ ' . TextService::mdv2(Lang::get('zentrotraderbot::bot.sign_offer.account_not_found')), 'chat' => ['id' => $bot->actor->user_id]];
        }
        ...
        if ($threadId && $supportId) {
            TelegramController::sendMessage([
                'message' => [
                    'text' =>
                        "✅ " . TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.ctrpart_thread_note')) . "\n" .
                        "🆔 `{$counterpartId}`",
                    'chat' => ['id' => $supportId],
                    'parse_mode' => 'MarkdownV2',
                    'message_thread_id' => (int) $threadId,
        ...
        return [
            'text' => '✅ ' . TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.ctrpart_sent')),
            'chat' => ['id' => $bot->actor->user_id],
            'editprevious' => 1,
            'reply_markup' => json_encode(['inline_keyboard' => [[['text' => '↖️ ' . TextService::mdv2(Lang::get('telegrambot::bot.options.backtomainmenu')), 'callback_data' => 'menu']]]]),
        ];
    ...
    public function solveDispute($bot, $code, $side)
    {
        ...
        try {
            ...
            $sideLabel = $side === 'buyer'
                ? TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.btn_favor_buyer'))
                : TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.btn_favor_seller'));
            ...
            if ($threadId && $supportId) {
                TelegramController::sendMessage([
                    'message' => [
                        'text' => "⚖️ *" . TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.solved_thread')) . "*\n"
                            . "🆔 `{$offer->code}`\n"
                            . "🏆 " . TextService::mdv2($sideLabel) . "\n"
                            . "🔗 `{$txHash}`",
                        'chat' => ['id' => $supportId],
                        'parse_mode' => 'MarkdownV2',
                        'message_thread_id' => (int) $threadId,
            ...
            return [
                'text' => "✅ *" . TextService::mdv2(Lang::get('zentrotraderbot::bot.offer.disputed.solved_done')) . "*\n🔗 `{$txHash}`",
                'chat' => ['id' => $bot->actor->user_id],
                'editprevious' => 1,
                'reply_markup' => json_encode(['inline_keyboard' => [[['text' => '↖️ ' . TextService::mdv2(Lang::get('telegrambot::bot.options.backtomainmenu')), 'callback_data' => 'menu']]]]),
            ];
    ...
    public function cancelOffer($bot, $code)
    {
        ...
        try {
            ...
            if (!$offer) {
                $reply["text"] = "⚠️ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.delete_offer.not_found"));
                return $reply;
            }

            // 2. Validar propiedad: Solo el creador puede cancelarla
            if ((int) $offer->user_id !== $userId) {
                $reply["text"] = "🚫 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.delete_offer.no_permission"));
                return $reply;
            }

            // 3. Verificar que esté abierta (Si ya hay un Escrow LOCK, no se puede cancelar así)
            if (strtoupper($offer->status) !== 'OPEN') {
                $reply["text"] = "🛑 " . TextService::mdv2(Lang::get("zentrotraderbot::bot.delete_offer.wrong_state"));
                return $reply;
            }
            ...
            $reply["text"] = "✅ *" . TextService::mdv2(Lang::get("zentrotraderbot::bot.delete_offer.success_title")) . "*\n" .
                "_" . TextService::mdv2(Lang::get("zentrotraderbot::bot.delete_offer.success")) . "_\n\n" .
                "👇 " . TextService::mdv2(Lang::get("telegrambot::bot.prompts.whatsnext"));

        } catch (\Exception $e) {
            Log::error("🆘 Error cancelando oferta {$code}: " . $e->getMessage());

            $reply["text"] = "❌ " . TextService::mdv2(Lang::get("zentrotraderbot::bot.delete_offer.error"));
        }
